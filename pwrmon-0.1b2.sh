...
sitename="My Tesla Site Name"
  ...
  echo -e "${CYellow}                                $solarshowline${CClear}"
  echo -e "         ${CWhite}${InvDkGray}   GRID   ${CClear}             ${CYellow}$solarshowline             ${CWhite}${InvBlue}   HOME   ${CClear}"
  echo -e "          $grid kW              ${CYellow}$solardirection1           ${CBlue}   $home kW${CClear}"
  echo -e "         ${CWhite}${InvDkGray} _/====\_ ${CClear}             ${CYellow}$solardirection2           ${CWhite}  ${InvBlue}  /====\| ${CClear}"
  echo -e "         ${CWhite}${InvDkGray} ! \||/ ! ${CClear}$gridshowlines${CBlack}${InvWhite}[GW]${CClear}$homeshowlines${CWhite}${InvBlue} /______\ ${CClear}"
  echo -e "         ${CWhite}${InvDkGray}   _||_   ${CClear}             ${CGreen}$batterydirection1          ${CWhite}   ${InvBlue} | |[]| | ${CClear}"
  echo -e "         ${CWhite}${InvDkGray} ^^^^^^^^ ${CClear}             ${CGreen}$batterydirection2         ${CBlue}    ${CWhite}${InvBlue} ^^^^^^^^ ${CClear}"
